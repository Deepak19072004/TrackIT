...
const SelectDropdown = ({options,value,onChange,placeholder}) => {
    ...
    return <div className='relative w-full'>
        <button 
            ...
            className='w-full text-sm cursor-pointer text-black outline-none bg-white border border-slate-100 px-2.5 py-3 rounded-md mt-2 flex justify-between items-center '
            >
